...
namespace MGJamSummer2018.Core
{
    public class CameraManager
    {
        ...
        {
            PlayerPosition = new Vector2(-entity.Position.X - (entity.BoundingBox.Width / 2) + GraphicsManager.Instance.VirtualResolution.X / 2, -entity.Position.Y - (entity.BoundingBox.Height / 2) + GraphicsManager.Instance.VirtualResolution.Y / 2);
